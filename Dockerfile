...
ARG APP_PACKAGE_RENCI_REGISTRY
ARG APP_PACKAGE_REGISTRY_TOKEN

# create the package registry access
RUN echo $APP_PACKAGE_RENCI_REGISTRY >> .npmrc
RUN printf "\n"  >> .npmrc
RUN echo $APP_PACKAGE_REGISTRY_TOKEN >> .npmrc
RUN printf "\n"  >> .npmrc
...
#ENV REACT_APP_GS_DATA_URL_AWS=$APP_GS_DATA_AWS_URL
#ENV REACT_APP_UI_DATA_URL_AWS=$APP_UI_DATA_AWS_URL
#ENV REACT_APP_UI_DATA_TOKEN_AWS=$APP_UI_DATA_AWS_TOKEN
#ENV REACT_APP_HURRICANE_ICON_URL_AWS=$APP_UI_HURRICANE_ICON_AWS_URL
...
RUN printf "REACT_APP_HURRICANE_ICON_URL_AWS=$APP_UI_HURRICANE_ICON_AWS_URL\n" >> .env
...
RUN printf "REACT_APP_HURRICANE_ICON_URL_PROD=$APP_UI_HURRICANE_ICON_PROD_URL\n" >> .env
