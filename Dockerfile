...
# now add the common values for ENV params
...
ENV REACT_APP_GS_DATA_PROD_URL=$APP_GS_DATA_PROD_URL
ENV REACT_APP_UI_DATA_PROD_URL=$APP_UI_DATA_PROD_URL
ENV REACT_APP_UI_DATA_PROD_TOKEN=$APP_UI_DATA_PROD_TOKEN
ENV REACT_APP_HURRICANE_ICON_PROD_URL=$APP_UI_HURRICANE_ICON_PROD_URL
...
ARG APP_UI_HURRICANE_ICON_DEV_URL=$(APP_UI_HURRICANE_ICON_DEV_URL)
ENV REACT_APP_GS_DATA_DEV_URL=$APP_GS_DATA_DEV_URL
ENV REACT_APP_UI_DATA_DEV_URL=$APP_UI_DATA_DEV_URL
ENV REACT_APP_UI_DATA_DEV_TOKEN=$APP_UI_DATA_DEV_TOKEN
ENV REACT_APP_HURRICANE_ICON_DEV_URL=$APP_UI_HURRICANE_ICON_DEV_URL
